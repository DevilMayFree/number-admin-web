    ...
    <el-card style="padding-bottom:100px;">
      ...
      <el-dialog title="领取" :visible.sync="openTake" width="500px" append-to-body>
        <el-form ref="takeForm" :model="takeForm" label-width="100px" label-position="top">
          ...
          <el-form-item>
            <el-button type="primary" @click="handleCount">获取年号</el-button>
          </el-form-item>
      ...
      <el-dialog title="验证码查看" :visible.sync="openIframeDialog" width="50%" append-to-body>
        <iframe :src="iframeUrl" frameborder="0" style="width: 100%; height: 80vh">
        </iframe>
      </el-dialog>
...
<script>
import {addBatch, getTakeContent, pageTgYear, pageTgYearLog, updateTake} from "@/api/tg/year";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      pageTgYear(this.queryParams).then(response => {
    ...
    getLogList() {
      ...
      pageTgYearLog(this.logQueryParams).then(response => {
