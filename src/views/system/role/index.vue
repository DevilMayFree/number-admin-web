<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编码" prop="code" :show-overflow-tooltip="true" width="150"/>
...
<!--              <el-dropdown-item command="handleDataScope" icon="el-icon-circle-check"
                                v-hasPermi="['sys:role:edit']">数据权限
              </el-dropdown-item>-->
              <el-dropdown-item command="handleAuthUser" icon="el-icon-user"
                                v-hasPermi="['sys:role:edit']">分配用户
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item prop="code">
          <span slot="label">
            <el-tooltip content="控制器中定义的角色编码，如：@PreAuthorize(`@as.hasRole('admin')`)" placement="top">
...
<script>
import {getRole, delRole, addRole, updateRole, dataScope, deptTreeSelect, pageRole} from "@/api/system/role";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      pageRole(dateRange(this.queryParams, this.dateRange)).then(response => {
