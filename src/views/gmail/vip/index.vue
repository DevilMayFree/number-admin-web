    ...
    <el-card style="padding-bottom:100px;">
      ...
      <el-dialog title="领取" :visible.sync="openTake" width="500px" append-to-body>
        <el-form ref="takeForm" :model="takeForm" label-width="100px" label-position="top">
          ...
          <el-form-item>
            <el-button type="primary" @click="handleCount">获取邮箱</el-button>
          </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="submitTakeForm" v-hasPermi="['gmail:vip:edit']"
      ...
      <el-dialog title="批量新增" :visible.sync="openAddBatch" width="500px" append-to-body>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="submitAddBatchForm" v-hasPermi="['gmail:vip:edit']">确 定
          </el-button>
...
<script>
import {addBatch, getTakeContent, pageGmailVIP, pageGmailVIPLog, updateTake,} from "@/api/gmail/vip";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      pageGmailVIP(this.queryParams).then(response => {
    ...
    getLogList() {
      ...
      pageGmailVIPLog(this.logQueryParams).then(response => {
